    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a BitcoinTrust address (e.g. B8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a BitcoinTrust address (e.g. B8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)"));
